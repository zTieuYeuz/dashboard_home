/* ───────────────────────────────────────────────────────────────────────────
 * FortiGate Auto-Login (content script, isolated world). User/pass lấy từ
 * creds.js (tự sinh lúc khởi động từ biến môi trường FGT_USER / FGT_PASS).
 * LƯU Ý: tài khoản auto-login KHÔNG được bật 2FA/FortiToken.
 * (Auto-login Hikvision DVR nằm ở hik-login.js — chạy MAIN world vì cần angular.)
 * ─────────────────────────────────────────────────────────────────────────── */
(function () {
